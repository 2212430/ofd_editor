  ...
  "node_modules/konva/lib/Node.js"(exports) {
    ...
    var Node = class _Node {
      ...
      _getTransform() {
        ...
        m.reset();
        const x2 = this.x(), y2 = this.y(), rotation = Global_1.Konva.getAngle(this.rotation()), scaleX = (_a2 = this.attrs.scaleX) !== null && _a2 !== void 0 ? _a2 : 1, scaleY = (_b = this.attrs.scaleY) !== null && _b !== void 0 ? _b : 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
        if (x2 !== 0 || y2 !== 0) {
          m.translate(x2, y2);
        }
        if (rotation !== 0) {
      ...
      _toKonvaCanvas(config) {
        ...
        const stage = this.getStage(), x2 = config.x !== void 0 ? config.x : Math.floor(box.x), y2 = config.y !== void 0 ? config.y : Math.floor(box.y), pixelRatio = config.pixelRatio || 1, canvas = new Canvas_1.SceneCanvas({
    ...
    exports.Easings = {
      ...
      ElasticEaseIn(t, b, c2, d, a, p2) {
        ...
        if (!a || a < Math.abs(c2)) {
          ...
          s2 = p2 / (2 * Math.PI) * Math.asin(c2 / a);
        }
        return -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s2) * (2 * Math.PI) / p2)) + b;
      },
      ElasticEaseOut(t, b, c2, d, a, p2) {
        ...
        return a * Math.pow(2, -10 * t) * Math.sin((t * d - s2) * (2 * Math.PI) / p2) + c2 + b;
      },
      ElasticEaseInOut(t, b, c2, d, a, p2) {
        ...
        if (t < 1) {
          return -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s2) * (2 * Math.PI) / p2)) + b;
        }
        return a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * d - s2) * (2 * Math.PI) / p2) * 0.5 + c2 + b;
      },
      ...
      BounceEaseIn(t, b, c2, d) {
        return c2 - exports.Easings.BounceEaseOut(d - t, 0, c2, d) + b;
      },
      BounceEaseInOut(t, b, c2, d) {
        if (t < d / 2) {
          return exports.Easings.BounceEaseIn(t * 2, 0, c2, d) * 0.5 + b;
        } else {
          return exports.Easings.BounceEaseOut(t * 2 - d, 0, c2, d) * 0.5 + c2 * 0.5 + b;
        }
      },
      EaseIn(t, b, c2, d) {
        return c2 * (t /= d) * t + b;
...
var require_BezierFunctions = __commonJS({
  "node_modules/konva/lib/BezierFunctions.js"(exports) {
    ...
    var getCubicArcLength = (xs, ys, t) => {
      ...
      sum = 0;
      for (let i = 0; i < n; i++) {
        correctedT = z2 * exports.tValues[n][i] + z2;
...
function O(o, t, a, i) {
  ...
  for (let n in a) {
    ...
    if (l && f) {
      ...
      g.slice(0, 7) === "content" && (g = "content" + g.slice(7, 1).toUpperCase() + g.slice(8)), e == null ? void 0 : e.off(g + N, a[n]);
    }
    !t.hasOwnProperty(n) && (e == null ? void 0 : e.setAttr(n, void 0));
  }
  for (let n in t) {
    if (T.hasOwnProperty(n))
      continue;
    ...
    if (l && f) {
      ...
      u.slice(0, 7) === "content" && (u = "content" + u.slice(7, 1).toUpperCase() + u.slice(8)), t[n] && (e == null ? void 0 : e.off(u + N), e == null ? void 0 : e.on(u + N, t[n]));
    }
    !l && (t[n] !== a[n] || i && t[n] !== (e == null ? void 0 : e.getAttr(n))) && (r = true, d[n] = t[n]);
  }
...
function V(o) {
  function t(a) {
    return (a == null ? void 0 : a.__konvaNode) ? a : (a == null ? void 0 : a.parent) ? t(a.parent) : (console.error("vue-konva error: Can not find parent node"), null);
  }
  return t(o.parent);
}
function x(o) {
...
function $(o) {
  ...
  if ((t == null ? void 0 : t.tagName) && a && !i) {
...
var _a;
var G = ((_a = import_konva.default.default) == null ? void 0 : _a.Stage) || import_konva.default.Stage;
var W = defineComponent({
  ...
  setup(o, { attrs: t, slots: a, expose: i }) {
    ...
    return onMounted(() => {
      ...
      var _a2;
      return h("div", { ref: r, style: t == null ? void 0 : t.style }, (_a2 = a.default) == null ? void 0 : _a2.call(a));
    };
  }
});
  ...
  return defineComponent({
    ...
    setup(a, { attrs: i, slots: e, expose: d }) {
      ...
      function g() {
        if (!r) return;
        const v = {};
        for (const _ in r == null ? void 0 : r.vnode.props)
      ...
      onMounted(() => {
        var _a2;
        const v = (_a2 = V(r)) == null ? void 0 : _a2.__konvaNode;
      ...
      return () => {
        var _a2;
        return m ? h("template", {}, (_a2 = e.default) == null ? void 0 : _a2.call(e)) : null;
      };
    }
  });
}
...
var s = import_konva.default.default || import_konva.default;
var Y = c("Arc", s.Arc);
...
var _e = {
  install: (o, t) => {
    const a = (t == null ? void 0 : t.prefix) || U, i = (t == null ? void 0 : t.customNodes) ? Object.entries(t.customNodes).map(
      ([d, r]) => c(d, r)
    ) : [];
    [
      W,
